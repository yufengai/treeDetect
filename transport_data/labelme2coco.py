...
if __name__ == '__main__':
    ...
    parser.add_argument("-s", "--src", help="need parse json dir")
    parser.add_argument("-d", "--dest", help="save file name")
    ...
    if debug :
        ...
        labelme2coco(labelme_json,args.dest)
